...
class S3Storage:
    ...
    def __init__(self, config):
        ...
        """
        logger.info(codes.STORAGE_INITIALIZING, backend=constants.STORAGE_BACKEND_S3)
    ...
    def _create_env_session(self, s3_config) -> boto3.Session:
        ...
        logger.info(
            codes.STORAGE_CREDENTIALS_FOUND,
            method=constants.S3_CREDENTIAL_METHOD_ENV_VARS,
        )
    ...
    def upload_file(self, file_stream: BinaryIO, filename: str) -> str:
        ...
        """
        logger.info(codes.STORAGE_UPLOADING, filename=filename, bucket=self.bucket_name)
    ...
    def download_file(self, filename: str) -> BinaryIO:
        ...
        logger.info(
            codes.STORAGE_DOWNLOADED, filename=filename, size=stream.getbuffer().nbytes
        )
    ...
    def delete_file(self, filename: str) -> bool:
        ...
        logger.info(
            codes.STORAGE_DELETED, filename=filename, message=codes.MSG_STORAGE_DELETED
        )
