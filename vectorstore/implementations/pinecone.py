...
class PineconeVectorStore:
    ...
    def __init__(self, config: "Config", embeddings: EmbeddingsProtocol):
        ...
        try:
            ...
            logger.error(codes.VECTORSTORE_ERROR, message=constants.ERROR_PINECONE_NOT_INSTALLED)
        ...
        try:
            ...
            for match in results.matches:
                formatted_results.append({
                    ...
                    constants.RESULT_KEY_TEXT: match.metadata.get(constants.PINECONE_METADATA_TEXT, ""),
