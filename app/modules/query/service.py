...
class QueryService(metaclass=SingletonMeta):
    ...
    def __init__(self):
        ...
        logger.info(
            codes.QUERY_SERVICE_INITIALIZED, msg=constants.MSG_QUERY_SERVICE_INITIALIZED
        )
    ...
    def _ensure_rag_chain_initialized(self) -> None:
        ...
        try:
            ...
            logger.error(codes.RAG_CHAIN_INIT_FAILED, error=str(e), exc_info=True)
    ...
    def query(self, question: str) -> Dict[str, Any]:
        ...
        try:
            logger.info(codes.QUERY_API_PROCESSING, msg=constants.MSG_QUERY_PROCESSING)
            ...
            logger.error(
                codes.QUERY_API_FAILED, error=str(e), question=question, exc_info=True
            )
