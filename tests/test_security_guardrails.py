...
from app.security.validators import ValidationResult
import constants
...
class TestGuardrailsManagerInputValidation:
    ...
    def test_valid_input_passes(self, manager):
        ...
        assert result[constants.VALIDATION_KEY_THREAT_LEVEL] == constants.THREAT_LEVEL_NONE
    ...
    def test_invalid_input_non_strict_mode(self):
        ...
        assert result[constants.VALIDATION_KEY_THREAT_LEVEL] == constants.THREAT_LEVEL_CRITICAL
...
class TestGuardrailsManagerOutputValidation:
    ...
    def test_valid_output_passes(self, manager):
        ...
        result = manager.validate_output("RAG stands for Retrieval-Augmented Generation")
        
        assert result[constants.VALIDATION_KEY_IS_SAFE] is True
        assert result[constants.VALIDATION_KEY_VALIDATED_OUTPUT] == "RAG stands for Retrieval-Augmented Generation"
        assert result[constants.VALIDATION_KEY_VIOLATIONS] == []
...
class TestGuardrailsManagerSecurityReport:
    ...
    def test_get_security_report_default_config(self):
        ...
        assert report[constants.GUARDRAILS_KEY_CONFIGURATION]["input_validation"] is True
        assert report[constants.GUARDRAILS_KEY_CONFIGURATION]["injection_detection"] is True
        assert report[constants.GUARDRAILS_KEY_CONFIGURATION]["output_validation"] is True
        assert report[constants.GUARDRAILS_KEY_CONFIGURATION]["strict_mode"] is True
        
        assert report[constants.GUARDRAILS_KEY_VALIDATORS]["input_validator"] == constants.GUARDRAILS_STATUS_ACTIVE
        assert report[constants.GUARDRAILS_KEY_VALIDATORS]["injection_detector"] == constants.GUARDRAILS_STATUS_ACTIVE
        assert report[constants.GUARDRAILS_KEY_VALIDATORS]["output_validator"] == constants.GUARDRAILS_STATUS_ACTIVE
    ...
    def test_get_security_report_custom_config(self):
        ...
        assert report[constants.GUARDRAILS_KEY_VALIDATORS]["input_validator"] == constants.GUARDRAILS_STATUS_DISABLED
        assert report[constants.GUARDRAILS_KEY_VALIDATORS]["output_validator"] == constants.GUARDRAILS_STATUS_DISABLED
        assert report[constants.GUARDRAILS_KEY_VALIDATORS]["injection_detector"] == constants.GUARDRAILS_STATUS_ACTIVE
