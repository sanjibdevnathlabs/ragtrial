...
class TestInitialization:
    ...
    def test_initialization_success(self, mock_config, mock_embeddings, mock_pinecone_client):
    ...
    def test_initialization_disables_ssl_when_configured(
        ...
        with patch("pinecone.Pinecone", return_value=mock_pinecone_client) as mock_pinecone:
            with patch("pinecone.ServerlessSpec"):
    ...
    def test_stores_configuration(self, mock_config, mock_embeddings, mock_pinecone_client):
...
class TestIndexInitialization:
    ...
    def test_initialize_gets_existing_index(self, pinecone_vectorstore, mock_pinecone_client):
...
class TestAddDocuments:
    ...
    def test_add_documents_includes_text_in_metadata(
        ...
        vectors = call_args.args[0] if call_args.args else call_args.kwargs.get("vectors")
