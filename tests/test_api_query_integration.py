...
def mock_query_service():
    ...
    mock.query.return_value = {
        ...
        constants.RESPONSE_KEY_SOURCES: [
            {
                "metadata": {constants.META_SOURCE: "source_docs/test.pdf"},
...
class TestQueryEndpoint:
    ...
    def test_query_with_no_answer(self, mock_service_class, client, mock_query_service):
        ...
        response = client.post("/api/v1/query", json={"question": "obscure question"})
    ...
    def test_query_with_multiple_sources(
        self, mock_service_class, client, mock_query_service
    ):
