...
class TestS3StorageInitialization:
    ...
    def test_initialization_with_credential_chain(
        self, mock_config, mock_boto3_session, mock_s3_client
    ):
    ...
    def test_initialization_verifies_bucket_access(
        self, mock_config, mock_boto3_session, mock_s3_client
    ):
...
class TestS3StorageDelete:
    ...
    def test_delete_existing_file(self, s3_storage, mock_s3_client):
        ...
        mock_s3_client.delete_object.assert_called_once_with(
            Bucket="test-rag-documents", Key=filename
        )
...
class TestS3StorageList:
    ...
    def test_list_files_with_prefix(self, s3_storage, mock_s3_client):
        ...
        paginator = MagicMock()
        paginator.paginate.return_value = [{"Contents": [{"Key": "docs/file1.txt"}]}]
...
class TestS3StorageMetadata:
    ...
    def test_get_metadata_nonexistent_file_raises_error(
        self, s3_storage, mock_s3_client
    ):
